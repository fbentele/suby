...
public class Album {
    ...
    public Album(String id, String name, String coverArt, String songCount, String artistId, String artist, String year) {
        super();
        this.id = id;
        this.name = name;
    ...
    public String getFullCoverArtPath() {
        String s = System.getProperty("user.home") + "/Music/Suby/" + getArtist().replace("/", "_") + "/" + getName().replace("/", "_") + "/al-" + getId()
                + ".jpg";
        return s;
    }
}
